    ...
    public class MockFlightDataSource : IFlightDataSource
    {
        public Task<IEnumerable<FlightInfo>> GetFlightsAsync()
        {
            return Task.FromResult(new List<FlightInfo>
            {
                ...
                new FlightInfo { FlightNumber = "MD101", Airline = "FilghtPop", DepartureTime = DateTime.Now.AddHours(5), ArrivalTime = DateTime.Now.AddHours(17), Price = 500, Stops = 3 },
        ...
        public Task<bool> BookFlightAsync(BookingRequest request)
        {
